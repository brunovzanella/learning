...
soma_coluna_12 = f'=SUM(L2:L{total - 1})'
...
celula_soma_12 = janeiro.cell(row=total, column=12, value=soma_coluna_12)
...
janeiro.cell(row=50, column=11, value="Total").font =Font(bold=True)
#pagina 2 (fevereiro)
...
celula_soma_12 = fevereiro.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
...
fevereiro.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 3 (março)
...
celula_soma_12 = marco.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
marco.cell(row=50, column=1, value="Total").font = Font(bold=True)
marco.cell(row=50, column=6, value="Total").font = Font(bold=True)
marco.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 4 (abril)
...
celula_soma_12 = abril.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
abril.cell(row=50, column=1, value="Total").font = Font(bold=True)
abril.cell(row=50, column=6, value="Total").font = Font(bold=True)
abril.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 5 (maio)
...
celula_soma_12 = maio.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
maio.cell(row=50, column=1, value="Total").font = Font(bold=True)
maio.cell(row=50, column=6, value="Total").font = Font(bold=True)
maio.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 6 (junho)
...
celula_soma_12 = junho.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
junho.cell(row=50, column=1, value="Total").font = Font(bold=True)
junho.cell(row=50, column=6, value="Total").font = Font(bold=True)
junho.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 7 (julho)
...
celula_soma_12 = julho.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
julho.cell(row=50, column=1, value="Total").font = Font(bold=True)
julho.cell(row=50, column=6, value="Total").font = Font(bold=True)
julho.cell(row=50, column=11, value="Total").font =Font(bold=True)
julho.cell(row=50, column=6, value="Total").font = Font(bold=True)
#página 8 (agosto)
...
celula_soma_12 = agosto.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
agosto.cell(row=50, column=1, value="Total").font = Font(bold=True)
agosto.cell(row=50, column=6, value="Total").font = Font(bold=True)
agosto.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 9 (setembro)
...
celula_soma_12 = setembro.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
...
setembro.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 10 (outubro)
...
celula_soma_12 = outubro.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
outubro.cell(row=50, column=1, value="Total").font = Font(bold=True)
outubro.cell(row=50, column=6, value="Total").font = Font(bold=True)
outubro.cell(row=50, column=11, value="Total").font =Font(bold=True)
#página 11 (novembro)
...
celula_soma_12 = novembro.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
...
celula_soma_12 = dezembro.cell(row=total, column=12, value=soma_coluna_12)
celula_soma_2.font = Font(bold=True)
celula_soma_7.font = Font(bold=True)
celula_soma_12.font = Font(bold=True)
...
dezembro.cell(row=50, column=11, value="Total").font =Font(bold=True)
#salvar planilha
planilha.save(r"C:\Users\bruno\OneDrive\Documents\planv2.xlsx")
